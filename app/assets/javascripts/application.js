...
;(function(global) {
    ...
    Loader.prototype.insertElement = function(
    ...
    Loader.prototype.useJsAnimations = function(element, options) {
        ...
        ;(function animate() {
            ...
            for (var j = 0; j < options.lines; j++) {
                alpha = Math.max(
                    1 - ((i + (options.lines - j) * astep) % f) * ostep,
                    options.opacity
                )
                Loader.prototype.opacity(
                    element,
                    j * options.direction + start,
                    alpha
                )
            }
    ...
    Loader.prototype.lines = function(element, options) {
        ...
        for (; i < options.lines; i++) {
            line = Loader.prototype.css(
                Loader.prototype.createSvgElement('rect', {
                    fill: options.color,
                    ...
                    transform:
                        'rotate(' +
                        ~~((360 / options.lines) * i + options.rotate) +
                        ', 0, 2) translate(' +
                        options.radius +
                        ' 0)',
                ...
                }),
                {
                    animation:
                        useCssAnimations &&
                        Loader.prototype.addAnimation(
                            options.opacity,
                            options.trail,
                            start + i * options.direction,
                            options.lines
                        ) +
                            ' ' +
                            1 / options.speed +
    ...
    Loader.prototype.initVML = function(options) {
        ...
        Loader.prototype.createVmlElement = function(tag, attr) {
            return Loader.prototype.createHtmlElement(
                '<' +
                    tag +
                    ' xmlns="urn:schemas-microsoft.com:vml" class="loading-vml">',
                attr
            )
        }
        ...
        Loader.prototype.lines = function(element, options) {
            ...
            function createGroupElement() {
                return Loader.prototype.css(
                    Loader.prototype.createVmlElement('group', {
                        coordsize: s + ' ' + s,
                        coordorigin: -r + ' ' + -r,
                    }),
                    { width: s, height: s }
            ...
            var g = Loader.prototype.css(createGroupElement(), {
                position: 'absolute',
                top: margin,
                left: margin,
            })
            ...
            function seg(i, dx) {
                Loader.prototype.insertElement(
                    g,
                    Loader.prototype.insertElement(
                        Loader.prototype.css(createGroupElement(), {
                            rotation: (360 / options.lines) * i + 'deg',
                            left: ~~dx,
                        }),
                        Loader.prototype.insertElement(
                            Loader.prototype.css(
                                Loader.prototype.createVmlElement('roundrect', {
                                    arcsize: options.corners,
                                }),
                                {
                                    width: r,
                                    height: options.width,
                            ...
                            Loader.prototype.createVmlElement('fill', {
                                color: options.color,
                                opacity: options.opacity,
                            }),
                            Loader.prototype.createVmlElement('stroke', {
                                opacity: 0,
    ...
    Loader.prototype.init = function(options) {
        if (options && options.container) {
            options = Loader.prototype.merge(
                options || {},
                Loader.defaults,
                defaults
            )
            ...
            sheet = (function() {
                var element = Loader.prototype.createHtmlElement('style', {
                    type: 'text/css',
                })
                Loader.prototype.insertElement(
            ...
            var probe = Loader.prototype.css(
                Loader.prototype.createHtmlElement('group'),
